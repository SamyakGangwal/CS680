...
import edu.umb.cs680.hw11.distance.Chebyshev;
import edu.umb.cs680.hw11.distance.Distance;
import edu.umb.cs680.hw11.distance.Euclidean;
import edu.umb.cs680.hw11.distance.Manhattan;
...
public class DistanceMetricTest {
	...
	public void verifyChebyshev() {
		...
		assertEquals(2.0, Distance.get(p1, p2, new Chebyshev()));
	}
	...
	public void verifyManhattan() {
		...
		assertEquals(4.0, Distance.get(p1, p2, new Manhattan()));
	}
	...
	public void verifyEuclideanMatrix() {
		...
		expected.add(Arrays.asList(0.0, 7.0710678118654755, 5.721013896155122, 19.162985153675823, 4.72122865364515));
		expected.add(Arrays.asList(7.0710678118654755, 0.0, 2.6324893162176366, 15.067182882012151, 9.0160967164289));
		expected.add(Arrays.asList(5.721013896155122, 2.6324893162176366, 0.0, 16.738876903783, 6.745368781616021));
		expected.add(Arrays.asList(19.162985153675823, 15.067182882012151, 16.738876903783, 0.0, 22.631173190977087));
		expected.add(Arrays.asList(4.72122865364515, 9.0160967164289, 6.745368781616021, 22.631173190977087, 0.0));
		...
		Distance.matrix(eucPoints).toArray()));
	}
	...
	public void verifyManhattanMatrix() {
		...
		assertTrue(Arrays.deepEquals(expected.toArray(),
		Distance.matrix(manhattanPoints, new Manhattan()).toArray()));
	}
	...
	public void verifyChebyshevMatrix() {
		...
		assertTrue(Arrays.deepEquals(expected.toArray(),
		Distance.matrix(chebyshevPoints, new Manhattan()).toArray()));
	}
}
